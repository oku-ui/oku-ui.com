...
<template>
  <div class="w-full">
    ...
    >
      ...
      <OkuToolbarSeparator class="w-[1px] bg-gray-300 mx-[10px]" />
      <OkuToolbarLink
        class="bg-transparent text-grayA-400 hidden sm:inline-flex justify-center items-center hover:bg-transparent hover:cursor-pointer flex-shrink-0 flex-grow-0 basis-auto h-[25px] px-[5px] rounded text-[13px] leading-none bg-codGray-800 ml-0.5 outline-none hover:bg-violet3 hover:text-violet11 focus:relative focus:shadow-[0_0_0_2px] focus:shadow-violet7 first:ml-0 data-[state=on]:bg-violet5 data-[state=on]:text-violet11"
        href="#"
        target="_blank"
      ...
      <OkuToolbarButton
        class="px-[10px] text-white font-medium bg-oku-500 flex-shrink-0 flex-grow-0 basis-auto h-[25px] rounded inline-flex text-[13px] leading-none items-center justify-center outline-none hover:bg-violet10 focus:relative focus:shadow-[0_0_0_2px] focus:shadow-violet7"
