...
<template>
  <div>
    ...
    <ULandingHero orientation="horizontal" class="!py-18 md:py-0 md:!pt-32 relative" :ui="{ container: 'flex lg:gap-4' }">
      ...
      <template #title>
         <span class="text-primary-400">1:1 </span> Radix UI components for Vue 
      </template>
    ...
    <ULandingSection>
      <template #title>
        1:1 Radix UI components for Vue

        <br><span class="text-primary-400">Vue, Nuxt Support</span>
      </template>
      <PrimitivesShow />
    </ULandingSection>
    ...
    <ULandingSection>
      ...
      <UPageGrid>
        <ULandingCard to="/getting-started/ssr" title="SSR Support" icon="i-solar-server-2-bold-duotone"
          description="Streamline the process of rendering and dispatching emails directly from your server." />
        <ULandingCard to="/getting-started/i18n" title="i18n Support" icon="i-solar-globus-bold-duotone"
          description="Sprinkle some global flavor onto your vue email templates with our new i18n feature!" />
        <ULandingCard to="/components/html" title="15+ Components" icon="i-ph-plug-duotone"
        ...
        <ULandingCard to="/integrations/mailersend" title="Integrations" icon="i-solar-bolt-line-duotone"
          description="Use your favorite email provider with VueEmail. Any Node.js email provider can be used with VueEmail." />
        <ULandingCard to="/getting-started/devtools" title="Nuxt Devtools" icon="i-ph-magic-wand-duotone"
          description="Inspect your email templates and send test emails from your app directly." />
        <ULandingCard to="/components/tailwind" title="Tailwind CSS" icon="i-solar-palette-round-line-duotone"
          description="
    ...
    <ULandingSection class="!pt-0">
      <ULandingCTA align="left" card :ui="{
          ...
          <ClientOnly>
            <UAvatarGroup :max="xlAndLarger ? 13 : lgAndLarger ? 10 : mdAndLarger ? 16 : 8" size="md"
              ...
              <UTooltip v-for="(contributor, index) of module.contributors" :key="index" :text="contributor.username"
                ...
                <UAvatar :alt="contributor.username"
                  ...
                  <NuxtLink :to="`https://github.com/${contributor.username}`" :aria-label="contributor.username"
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-8 lg:gap-16">
          ...
          <NuxtLink class="text-center group" to="https://github.com/oku-ui/primitives" target="_blank">
            <p
              class="text-6xl font-semibold text-gray-900 dark:text-white group-hover:text-primary-500 dark:group-hover:text-primary-400">
